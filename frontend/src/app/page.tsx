...
export default function Page() {
	...
	const { files, alerts, isLoading, isSubmitting, errorMessage, loadData, handleUpload } = useFiles();
	...
	return (
		<Container fluid className="py-4 px-4 bg-light min-vh-100">
						...
						<Card.Body className="p-4">
							<div className="d-flex justify-content-between align-items-start gap-3 flex-wrap">
								<div>
									...
									<p className="text-secondary mb-0">Загрузка файлов, просмотр статусов обработки и ленты алертов.</p>
								</div>
			...
			<UploadModal show={showModal} onHide={() => setShowModal(false)} onUpload={handleUpload} isSubmitting={isSubmitting} />
		</Container>
	);
}
